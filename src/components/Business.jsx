...
const FeatureCard = ({ icon, title, content, index }) => (
  ...
  >
    ...
    <div className="flex-1 flex flex-col ml-3">
      <h4 className="font-poppins mb-1 font-semibold text-dimWhite text-[18px] leading-[23px]">
        {title}
      </h4>
      <p className="font-poppins mb-1 font-normal text-dimWhite text-[16px] leading-[24px]">
        {content}
      </p>
    </div>
  </div>
